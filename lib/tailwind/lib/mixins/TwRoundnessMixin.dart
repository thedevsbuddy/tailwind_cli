...
///
/// [target] Provides the target directory for the `TwRoundnessMixin` class
const String target = "tailwind/lib/mixins/";

/// Get the full file path for the `TwRoundnessMixin` Class
///
/// [file] This gives a boilerplate for the `TwRoundnessMixin` class
const String file = "tailwind/lib/mixins/TwRoundnessMixin.dart";

/// Get the stub content for the `TwRoundnessMixin` Class
///
/// [stub] This gives a boilerplate for the `TwRoundnessMixin` class
const String stub = """
