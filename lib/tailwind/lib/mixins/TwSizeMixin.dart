...
///
/// [target] Provides the target directory for the `TwSizeMixin` class
const String target = "tailwind/lib/mixins/";

/// Get the full file path for the `TwSizeMixin` Class
///
/// [file] This gives a boilerplate for the `TwSizeMixin` class
const String file = "tailwind/lib/mixins/TwSizeMixin.dart";

/// Get the stub content for the `TwSizeMixin` Class
///
/// [stub] This gives a boilerplate for the `TwSizeMixin` class
const String stub = """
