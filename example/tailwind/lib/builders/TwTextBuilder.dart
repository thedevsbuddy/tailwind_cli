...
class TwTextBuilder extends TwWidgetBuilder<Widget> with TwColorMixin<TwTextBuilder> {
  ...
  /// ============== FONT SIZES ============== ///
  TwTextBuilder get textBase => this.._fontSize = Tw.textBase;
	TwTextBuilder get textXs => this.._fontSize = Tw.textXs;
	TwTextBuilder get textSm => this.._fontSize = Tw.textSm;
	TwTextBuilder get textLg => this.._fontSize = Tw.textLg;
	TwTextBuilder get textXl => this.._fontSize = Tw.textXl;
	TwTextBuilder get textXl2 => this.._fontSize = Tw.textXl2;
	TwTextBuilder get textXl3 => this.._fontSize = Tw.textXl3;
	TwTextBuilder get textXl4 => this.._fontSize = Tw.textXl4;
	TwTextBuilder get textXl5 => this.._fontSize = Tw.textXl5;
	TwTextBuilder get textXl6 => this.._fontSize = Tw.textXl6;
	TwTextBuilder get textXl7 => this.._fontSize = Tw.textXl7;
	TwTextBuilder get textXl8 => this.._fontSize = Tw.textXl8;
	TwTextBuilder get textXl9 => this.._fontSize = Tw.textXl9;
